...
def main() -> None:
    ...
    # Live provider and AWS catalogue diagnostics belong behind the
    # authenticated admin route. They must never delay the server from accepting
    # health checks when an external service is slow or unavailable.
